@php
    $dashboardRoute = Auth::check() && Auth::user()->hasRole('admin') ? 'admin.dashboard' : 'dashboard';
@endphp
...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('customer.vehicles.index')"
                                :active="request()->routeIs('customer.vehicles.*')">
                        Vehicles
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @role('teknisi')
                <x-responsive-nav-link :href="route('technician.bookings.index')" :active="request()->routeIs('technician.bookings.*')">
                    Bookings
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('technician.reviews.index')" :active="request()->routeIs('technician.reviews.*')">
                    Reviews
                </x-responsive-nav-link>
            @endrole
        </div>
